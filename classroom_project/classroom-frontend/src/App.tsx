          ...
          >
            ...
            <DocumentTitleHandler
              handler={({ autoGeneratedTitle }) =>
                // Refine's default title is the bare string "Refine" (no
                // " | " prefix) on any route with no matched resource -
                // the dashboard/home route and the login page included, so
                // exactly the pages most people land on first. A regex
                // anchored on " | Refine$" never matched that bare case,
                // which is what left the tab reading plain "Refine".
